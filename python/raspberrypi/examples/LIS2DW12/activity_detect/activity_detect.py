...
class Accelerometer:
  def __init__(self, activity_callback: function):
    ...
    self.acce.begin()
    #Get chip id
    print('chip id :%x'%self.acce.get_id())
    ...
    '''
        ...
        |------------------------------------------------------------------------------------------------------------------------|
    '''
    self.acce.set_wakeup_dur(dur = 6)
    ...
    '''
    self.acce.set_act_mode(self.acce.DETECT_ACT)
    ...
    '''
    self.acce.set_int1_event(self.acce.WAKEUP)
